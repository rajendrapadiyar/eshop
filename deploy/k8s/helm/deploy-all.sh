...
Parameters:
  ...
  -n | --app-name <the name of the app>
    Specifies the name of the application (default: hcl-apps-paas).
...
app_name='eshop'
aks_name='hcl-eus-aks-d-cluster-01'
aks_rg='hcl-eus-rsg-d-cluster'
build_images=''
clean='yes'
build_solution=''
container_registry='demoeusacrdt01.azurecr.io'
docker_password='jsNAuuEA3GDXFOLL+5alSwh4K5jbHHM7'
docker_username='demoeusacrdt01'
dns=''
image_tag='latest'
push_images=''
skip_infrastructure=''
use_local_k8s=''
namespace='hcl-apps-paas'
use_mesh='false'

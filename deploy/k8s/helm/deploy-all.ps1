Param(
    [parameter(Mandatory=$false)][string]$registry="demoeusacrdt01.azurecr.io",
    [parameter(Mandatory=$false)][string]$dockerUser="demoeusacrdt01",
    [parameter(Mandatory=$false)][string]$dockerPassword="jsNAuuEA3GDXFOLL+5alSwh4K5jbHHM7",
    ...
    [parameter(Mandatory=$false)][string]$aksName="hcl-eus-aks-d-cluster-01",
    [parameter(Mandatory=$false)][string]$aksRg="hcl-eus-rsg-d-cluster",
